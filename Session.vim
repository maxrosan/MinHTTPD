...
silent only
cd ~/Documents/Sources/trabalhos/redes/server_httpd/src
...
badd +0 httpd.h
badd +0 config.ini
badd +61 lib/iniparser-2.17/src/iniparser.h
badd +3 ex.php
args server.c
edit server.c
...
silent! normal! zE
let s:l = 46 - ((13 * winheight(0) + 19) / 38)
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 72 + 94) / 189)
exe 'vert 2resize ' . ((&columns * 116 + 94) / 189)
argglobal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 69 - ((25 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 84 - ((17 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
